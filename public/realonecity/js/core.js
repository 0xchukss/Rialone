...
GTA.Game = function ( ) {
    ...
    this.loaded = function () {
      ...
      //  console.log(this.map.sections);
        ...
        if (GTA.RialoneOpenWorld !== undefined) {
            this.openWorld = new GTA.RialoneOpenWorld(this);
            this.openWorld.start();
        } else if (GTA.RetrievalMissions !== undefined) {
 ...
 //   window.document.body.appendChild(  GTA.Debug.createPhysicsDebug.call ( this ) );
    ...
    methods = {
        ...
        render: function() {
            ...
            if (this.openWorld !== undefined) {
                this.openWorld.update( delta );
            }
